...
You are free to use a soundfont of your choosing, just make sure to update `SF2_PATH` in [`__init__.py`](../__init__.py) to point to its location. Note only `.sf2` soundfonts are supported.
