#!/usr/bin/env bash
#SBATCH --job-name=imp_npz_eval
#SBATCH --partition=cmp
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --time=03:00:00
#SBATCH --output=/WAVE/datasets/ccoelho_lab-jlanders/Impromptu/logs/imp_npz_eval_%j.out
#SBATCH --error=/WAVE/datasets/ccoelho_lab-jlanders/Impromptu/logs/imp_npz_eval_%j.err
...
python Impromptu/scripts/debug_evaluate_existing_npzs.py --limit 10
